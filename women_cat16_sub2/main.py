...
# Hardcoded subcategory URLs for Derma Beauty - Other Categories
SUBCATEGORY_URLS = [
    "https://www.boutiqaat.com/ar-kw/women/derma-beauty/makeup/l/",
    "https://www.boutiqaat.com/ar-kw/women/derma-beauty/bath-body-derma-beauty/l/",
    "https://www.boutiqaat.com/ar-kw/women/derma-beauty/hair-care-derma-beauty/l/",
    "https://www.boutiqaat.com/ar-kw/women/derma-beauty/international-fragrances/l/",
]
...
class BoutiqaatDataPipeline:
    ...
    def _upload_product_image(self, product: Dict, category_name: str, subcategory_name: str) -> str:
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/derma-beauty/images/"
                f"{safe_category}"
            )
    ...
    def _upload_excel_file(self, local_path: str, category_name: str) -> bool:
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/derma-beauty/excel-files"
            )
